...
export default function LineupCreator({
  ...
  const [draggedFromPosition, setDraggedFromPosition] = useState<string | null>(
    null,
  );
        ...
        <div className="flex items-start space-x-2">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-blue-700 mt-1">
              Drag players from the list on the left onto the field positions.
              You can also drag players between positions to rearrange them.
            </p>
          </div>
        </div>
      </div>
